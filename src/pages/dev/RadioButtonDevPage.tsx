...
export const RadioButtonDevPage = () => {
  ...
  return (
    <div className="min-h-screen w-full space-y-8 bg-background p-6">
      ...
      <section className="space-y-4 rounded-xl border border-border bg-card p-6 shadow-xs">
        <div className="border-b border-border pb-3">
          <h2 className="text-title-1 font-semibold text-foreground">2. Nhóm tùy chọn tương tác (Interactive Group)</h2>
          <p className="text-body-2-rg text-muted-foreground mt-0.5">Liên kết nhãn và bắt sự kiện thay đổi giá trị.</p>
        </div>
