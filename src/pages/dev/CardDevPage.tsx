  ...
  <div className="min-h-screen w-full space-y-8 bg-background p-6">
    ...
    <section className="space-y-4 rounded-xl border border-border bg-card p-6 shadow-xs">
      <div className="border-b border-border pb-3">
        <h2 className="text-title-1 font-semibold text-foreground">1. Các biến thể (Variants)</h2>
        <p className="text-body-2-rg text-muted-foreground mt-0.5">Thẻ viền tiêu chuẩn, thẻ nền đầy (filled) và thẻ nổi (elevated).</p>
      </div>
