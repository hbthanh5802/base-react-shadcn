...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { key: 'dev-sidebar', to: '/dev/sidebar', label: 'Thanh điều hướng (Sidebar)' },
  ...
  },
  {
    ...
    label: 'NÚT BẤM & FORM',
    items: [
      { key: 'dev-button', to: '/dev/button', label: 'Nút bấm (Button & IconButton)' },
      { key: 'dev-form', to: '/dev/form', label: 'Form Tổng hợp (Hook Form + Zod)' },
  ...
  },
  {
    ...
    items: [
      { key: 'dev-table', to: '/dev/tanstack-table', label: 'Bảng dữ liệu (TanStack Table)' },
      { key: 'dev-pagination', to: '/dev/pagination', label: 'Phân trang (Pagination)' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'dev-chart', to: '/dev/chart', label: 'Biểu đồ (Chart - Recharts)' },
      { key: 'dev-doc-viewer', to: '/dev/document-viewer', label: 'Xem tài liệu (Document Viewer)' },
  ...
  },
  {
    ...
    defaultOpen: true,
    items: [
      { key: 'page-404', to: '/404', label: 'Trang 404 (Không tìm thấy)' },
      { key: 'page-403', to: '/403', label: 'Trang 403 (Truy cập bị từ chối)' },
      { key: 'page-login', to: '/login', label: 'Trang Đăng nhập (Login)' },
      { key: 'page-home', to: '/home', label: 'Trang chủ Ứng dụng (HomePage)' },
    ],
  },
];
